...
analyze -library WORK -format sverilog {/home/rfebbo/Research/rocco_CSA/simp_pipe_builtin.sv}

elaborate simp_pipe_builtin -architecture verilog -library WORK
...
write -f verilog -h -o builtin_GLN.v

write_sdf builtin_GLN.sdf
write_sdc builtin_GLN.sdc